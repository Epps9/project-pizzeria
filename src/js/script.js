...

{
  ...
  class Cart {
    ...
    add(menuProduct){
      ...
      /*create HTML code using handlebars and save it in const generatedHTML*/
      const generatedHTML = templates.cartProduct(menuProduct);
      /*change generatedHTML to DOM element and save in const generatedDOM*/
    ...
    initData: function () {
      ...
      fetch(url)
        ...
        .then(function(parsedResponse){
          ...
          thisApp.parsedResponse = thisApp.data.products;
